...
const ExhibitionsModule = (props) => {
  ...
  return (
    <ExhibitionModule>
      ...
      <Heading>
      <h1 className={value === 0 ? 'is-active' : 'not-active'} style={{visibility: `${pastEvents.length !== 0 ? 'visible' : 'hidden' }`}} onClick={() => setValue(0)}>past</h1>
      <h1 className={value === 1 ? 'is-active' : 'not-active'} style={{visibility: `${nowEvents.length !== 0 ? 'visible' : 'hidden' }`}} onClick={() => setValue(1)}>on view</h1>
      <h1 className={value === 2 ? 'is-active' : 'not-active'} style={{visibility: `${soonEvents.length !== 0 ? 'visible' : 'hidden' }`}} onClick={() => setValue(2)}>soon</h1>
      </Heading>
